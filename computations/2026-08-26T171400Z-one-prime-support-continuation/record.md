# One-prime support continuation map and T=2/5 certificate candidate

- **Computation ID:** `X-20260826-001`
- **Created:** `2026-08-26T17:14:00Z`
- **Last updated:** `2026-08-26T17:28:53Z`
- **Type:** `MIXED RIGOROUS-ASSEMBLY RECONNAISSANCE / GENERATOR-SIDE EXACT CANDIDATE`
...
3. `candidate-T040-N40.json`: generator-side exact rational outward rounding, exact rational Schur construction, and exact rational congruence/Gershgorin margins. This is stronger candidate evidence but is **not independently verified** and is not a theorem certificate.
...
The one-prime mechanism is not isolated at `T=0.35`. A moving Legendre cutoff restores the full-tail Schur architecture at least to the `T=0.4` candidate. The next rigorous target is `T=2/5,N=40`.

No new support value is registered as proved by this computation. Independent Rust verification under a closed extended contract remains mandatory.
