...
EXPECTED_RETAINED_CLAIMS_V1 = frozenset({"C-0050", "C-0051", "C-0052", "C-0053", "C-0054", "C-0055", "C-0056", "C-0057"})
...
def validate_retained_proof_manifest(document: Any) -> RetainedProofManifest:
    ...
    if claim_set != EXPECTED_RETAINED_CLAIMS_V1:
        ...
        raise RetainedProofManifestError(
            "$.proofs must contain exactly C-0050 through C-0057 (" + "; ".join(details) + ")"
        )
